...
import 'package:sahar/features/tvs/presentation/cubit/popular_tvs/popular_tvs_cubit.dart';
import 'package:sahar/features/tvs/presentation/screens/tv_detail_screen.dart';

import 'package:shimmer/shimmer.dart';

class PopularTVsBottomSheet extends StatelessWidget {
  const PopularTVsBottomSheet({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<PopularTVsCubit, PopularTVsState>(
      builder: (context, state) {
        if (state is PopularTVsInitial) {
